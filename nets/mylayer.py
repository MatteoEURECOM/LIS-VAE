...
class BayesConv2dTranspose(_BayesConvNd):
    r"""
    ...
    """
    def __init__(self, prior_mu, prior_sigma, in_channels, out_channels, kernel_size, stride=1, padding=0,  groups=1, bias=True, dilation=1,output_padding=1,padding_mode='zeros'):
        kernel_size = _pair(kernel_size)
        stride = _pair(stride)
        padding = _pair(padding)
        dilation = _pair(dilation)
        super(BayesConv2dTranspose, self).__init__( prior_mu, prior_sigma, in_channels, out_channels, kernel_size, stride,padding, dilation, False, output_padding,  groups, bias, padding_mode)

    def conv2d_transpose_forward(self, input, weight):
        ...
        if self.bias:
            ...
            bias = None
        return F.conv_transpose2d(input, weight, bias, stride=self.stride, padding=self.padding, dilation=self.dilation, groups=self.groups)
    ...
    def forward(self, input):
            ...
            return self.conv2d_transpose_forward(input, weight)